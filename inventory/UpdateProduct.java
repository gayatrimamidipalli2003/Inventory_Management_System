...
public class UpdateProduct extends JFrame implements ActionListener{
    ...
    JFrame f;
    JDateChooser dc;
    JTextField productupdate, nameupdate, companyupdate, priceunit, updatequantity;
    ...
    public UpdateProduct() {
        ...
        JLabel updateuser = new JLabel("Update Product");
        ...
        JLabel updatemedicine = new JLabel("Product ID");
        updatemedicine.setBounds(250, 140, 170, 20);
        updatemedicine.setFont(new Font("Times New Roman", Font.BOLD, 20));
        f.add(updatemedicine);

        productupdate = new JTextField();
        productupdate.setBounds(380, 140, 200, 24);
        productupdate.setBorder(BorderFactory.createLineBorder(Color.black));
        f.add(productupdate);
        ...
        JLabel updatexp = new JLabel("Date of Purchase");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            ...
            String uniqueId =productupdate.getText();
            if (uniqueId.equals("")) {
                ...
                try {
                    ...
                    ResultSet rs = st.executeQuery("select * from product where productId='" + uniqueId + "'");
                    while (rs.next()) {
            ...
            String Dop = df.format(dc.getDate());
            ...
            if (uniqueId.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Date of Purchase is required.");
            } else {
                try {
                    Connection con = ConnectionProvider.getCon();
                    PreparedStatement ps = con.prepareStatement("update product set Name=?, CompanyName=?, Quantity=?, Price=?, Dop=? where productId=?");
                    ps.setString(1, name);
