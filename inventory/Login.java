...
public class Login extends JFrame implements ActionListener {
    ...
    public Login() {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("inventory/loginbackground.JPG"));
        Image i9=img.getImage().getScaledInstance(650, 768, Image.SCALE_SMOOTH);
